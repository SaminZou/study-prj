...
public class Java8StreamUseCase {
    ...
    public static void main(String[] args) {
        ...
        Map<String, Set<Integer>> collect2 = list2.stream()
                                                  .collect(Collectors.groupingBy(Obj::getFoo, Collectors.mapping(Obj::getBar,
                                                                                                                 Collectors.toSet())));
        ...
        Map<String, Integer> collect3 = list2.stream()
                                             .collect(Collectors.toMap(Obj::getFoo, Obj::getBar,
        ...
        Map<String, Obj> collect4 = list2.stream()
                                         .collect(Collectors.toMap(Obj::getFoo, Function.identity(),
                                                                   (oldValue, newValue) -> newValue));
