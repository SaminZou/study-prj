...
不同家的分词器实现不同，同一个单词 token 量可能不同

- 如何优化 Token 消耗

  - 精简 Prompt: 避免冗余的描述，用最简洁的语言表达需求 
  - 善用上下文: 在多轮对话中，避免重复已说过的内容
  - 合理设置长度限制: 如果不需要长回答，明确告诉模型"用 100 字回答"
  - 英文场景优先英文: 如果你的内容本身是英文，直接用英文提问更省 Token

中文、日文等字符密度高的语言，Token 消耗远高于英文。这是一个全球 AI 社区都在关注的公平性问题。
