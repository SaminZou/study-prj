...
public class Token {
  ...
  public static byte[] HmacEncrypt(String data, String key, String signatureMethod)
    ...
    signinKey =
        new SecretKeySpec(Base64.getDecoder().decode(key), "Hmac" + signatureMethod.toUpperCase());
  ...
  public static void main(String[] args)
    ...
    System.out.println(
        assembleToken(version, resourceName, expirationTime, signatureMethod, accessKey));
  }
}
